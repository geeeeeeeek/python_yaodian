        ...
        <div style="padding-right: 16px; max-height:480px; overflow-x: hidden;overflow-y: auto;">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="功效" name="gongxiao">
                  <a-input placeholder="请输入" v-model:value="modal.form.gongxiao"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="服用方式" name="fuyongfangshi">
                  <a-input placeholder="请输入" v-model:value="modal.form.fuyongfangshi"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
