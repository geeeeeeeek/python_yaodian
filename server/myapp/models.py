...
class Customer(models.Model):
    ...
    jifen = models.CharField(max_length=20, blank=True, null=True)
...
class Thing(models.Model):
    ...
    name = models.CharField(max_length=20, blank=True, null=True)
    property = models.CharField(max_length=20, blank=True, null=True)  # 库存
    price = models.CharField(max_length=20, blank=True, null=True)
    gongxiao = models.CharField(max_length=50, blank=True, null=True)  # 功效
    fuyongfangshi = models.CharField(max_length=50, blank=True, null=True)  # 服用方式
    remark = models.CharField(max_length=30, blank=True, null=True)
