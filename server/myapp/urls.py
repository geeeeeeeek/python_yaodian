...
urlpatterns = [
    ...
    path('admin/customer/list', views.admin.customer.list_api),
    path('admin/customer/create', views.admin.customer.create),
    path('admin/customer/update', views.admin.customer.update),
    path('admin/customer/delete', views.admin.customer.delete),
